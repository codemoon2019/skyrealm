...
import { allAssetUrls } from './assets/assetManifest.ts';
...
export default function App() {
  ...
  useEffect(() => {
    ...
    push();
    void assets.load(allAssetUrls()).then(() => {
      if (!alive) return;
      setLoadPct(1);
      setReady(true);
    });
  ...
  useEffect(() => {
    const hangar = shell === 'game' && gameState === GameState.MENU;
  ...
  }, [shell, snap.skyTop, snap.skyGlow, snap.skyMid, snap.skyGround]);
